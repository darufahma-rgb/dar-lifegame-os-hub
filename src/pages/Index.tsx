        ...
        <div className="min-h-screen">
          ...
          <div className="relative h-32 sm:h-48 md:h-64 overflow-hidden">
            ...
            <div className="absolute bottom-2 left-2 sm:bottom-4 sm:left-4">
              <div className="w-8 h-8 sm:w-10 sm:h-10 rounded-full bg-neon-green shadow-lg shadow-neon-green/50" />
            </div>
          </div>
          ...
          <div className="px-3 sm:px-4 md:px-8 py-4 sm:py-6 max-w-[1600px] mx-auto">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-4 gap-4 sm:gap-6 mt-6 sm:mt-8">
